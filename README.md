...
🌐 **線上 Demo** → [https://jungcharlix.github.io/toefl-prep/](https://jungcharlix.github.io/toefl-prep/)
...
- **使用瀏覽器 Web Speech API 真實朗讀講稿**(免費、離線可用)
- 可展開完整 transcript 對照
- 提供 ETS 官方練習與 YouTube TPO 真題連結
- 雙欄筆記本(主旨 / 細節)
...
本專案已部署於:**[https://jungcharlix.github.io/toefl-prep/](https://jungcharlix.github.io/toefl-prep/)**
